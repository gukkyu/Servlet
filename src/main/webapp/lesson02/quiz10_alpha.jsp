...
<body>
	...
	<div class = "container">
		<header class = "d-flex align-items-center">
			<h2><b><a href = "/lesson02/quiz10_alpha.jsp" style = "text-decoration: none;" class = "text-success mr-5">Melong</a></b></h2>
			<form method = "get" action = "/lesson02/quiz10_alpha.jsp" class = "d-flex w-100 ml-5">
		...
		<section>
			<div class = "border border-success w-100 p-3 d-flex">
				...
				<div class = "ml-3">
					...
					<div class = "mt-2"><small><%= agency %></small></div>
					<div><%= debute %><small> 데뷔</small></div>
				</div>
			</div>
			<h4 class = "my-3"><b>곡 목록</b></h4>
			<table class = "table text-center">
				...
				<tbody>
					...
					<tr>
						...
						<td><a href = "/lesson02/quiz10_alpha.jsp?no=<%= musicList.get(i).get("id") %>"><%= musicList.get(i).get("title") %></a></td>
		...
		<%
	    	} else if (search != null && i == musicList.size() - 1 && search.equals(musicList.get(i).get("title")) == false){
